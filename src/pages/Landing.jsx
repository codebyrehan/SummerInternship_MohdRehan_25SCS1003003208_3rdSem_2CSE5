...
function LiveTemplateShowcase() {
  ...
  const themes = [
    { id: 'modern', name: 'Modern Violet', accent: 'bg-violet-600', text: 'text-violet-400', border: 'border-violet-500/30' },
    { id: 'slate', name: 'Tech Emerald', accent: 'bg-emerald-600', text: 'text-emerald-400', border: 'border-emerald-500/30' },
    { id: 'cyber', name: 'Cyber Blue', accent: 'bg-blue-600', text: 'text-blue-400', border: 'border-blue-500/30' },
    { id: 'minimal', name: 'Executive Dark', accent: 'bg-zinc-700', text: 'text-zinc-300', border: 'border-zinc-500/30' }
  ];
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-white/50">Export cleanly in standard A4 PDF formats accepted by Fortune 500 recruiters</p>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          {themes.map((t) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-semibold flex items-center gap-2 border transition-all ${selectedTheme === t.id ? `${t.border} bg-white/10 text-white shadow-lg` : 'border-white/5 bg-white/[0.02] text-white/50 hover:text-white'}`}
            >
      ...
      <SpotlightCard className="p-8" color="rgba(99,102,241,0.12)">
        <div className="max-w-2xl mx-auto bg-white text-[#111827] rounded-2xl p-8 shadow-2xl space-y-6 text-left">
          {/* Header */}
          <div className="border-b border-gray-200 pb-4 flex justify-between items-start">
            <div>
              ...
              <p className="text-sm font-semibold text-violet-700 mt-0.5">Software Engineering Student & Full-Stack Developer</p>
              <div className="flex flex-wrap gap-3 text-xs text-gray-500 mt-2">
                <span>rehan@example.com</span> • <span>linkedin.com/in/rehan</span> • <span>github.com/rehan</span>
              </div>
            </div>
            <span className="text-[10px] font-bold px-2 py-1 rounded bg-green-100 text-green-800 uppercase tracking-wider">
              ATS Score: 98%
            </span>
          </div>
          ...
          <div className="space-y-4">
            <div>
              <h5 className="text-xs font-bold text-gray-900 uppercase tracking-wider border-b border-gray-100 pb-1 mb-2">
                Key Technical Projects
              </h5>
              <div className="space-y-2">
                <div className="flex justify-between items-baseline text-xs">
                  <span className="font-bold text-gray-900">QuickHire AI — SaaS Career Development Suite</span>
                  <span className="text-gray-500">React, Node.js, Google Gemini</span>
                </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {['JavaScript (ES6+)', 'React.js', 'Node.js', 'Express', 'TailwindCSS', 'REST APIs', 'Git', 'Google Gemini AI'].map((s) => (
                  <span key={s} className="px-2 py-0.5 bg-gray-100 text-gray-800 text-[11px] rounded font-medium">
                    {s}
                  </span>
                ))}
              </div>
        ...
        <div className="text-center mt-6">
          <Link to="/build">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-2 bg-violet-600 hover:bg-violet-500 text-white text-sm font-semibold px-6 py-3 rounded-xl shadow-lg shadow-violet-500/25 transition-all"
            >
              <Sparkles className="w-4 h-4" /> Customize & Download Yours in PDF
            </motion.button>
          </Link>
        </div>
      </SpotlightCard>
